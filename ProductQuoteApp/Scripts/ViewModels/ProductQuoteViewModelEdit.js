(function () {
    ...
    //var initData = @Html.Raw(ViewBag.CurrentCustomerID);
    ...
    var validateCustomerCompanyName = function (val) {
        //if ((val == undefined) || (val == "Empresa Cliente"))
        if (val == undefined)
            return false;
        else
            return true;
    ...
    var ProductQuoteViewModel = function () {
        ...
        self.productQuoteID = ko.observable($('#myHDProductQuoteID').val());
        console.log('self.productQuoteID: ' + self.productQuoteID());
        getProductQuote(self.productQuoteID());
        ...
        self.customerCompanyName = ko.observable().extend({
            ...
            validation: {
                ...
                message: "Debe ingresar el 'Nombre de la Empresa'",
                onlyIf: function () { return self.customerCompanyNameValidateTrue(); }
                //params: self.customerCompanyNameValidateTrue()
            }
        });
        ...
        self.productValidityOfPriceInput = ko.observable().extend({
            validation: {
        ...
        //            target.validationMessage("Se espera un valor mayor a " + minValue);
        //        }
        //    }
        ...
        function getProductQuote(productQuoteId) {
            $.ajax({
                url: "/GetProductQuote/" + productQuoteId,
                type: "GET",
        ...
        self.selectedCustomer.subscribe(function (item) {
            ...
            if (item !== undefined) {
                ...
                self.customerContactName(item.CustomerName);
        ...
        function loadProductList() {
            ...
            $.ajax({
                url: "/GetProductsActive/" + self.customerID(),
                type: "GET",
        ...
        self.createProductQuote = function () {
            ...
            console.log("PRODUCT QUOTE CREATE - ENVIO DATOS");
            console.log(ko.toJSON(productQuote));
            if (self.errors().length === 0) { 
                $.ajax({
                    url: "/CreateProductQuote",
                    type: "POST",
                    data: ko.toJSON(productQuote),
                    contentType: "application/json",
                    success: function (data) {
    ...
    var vm = new ProductQuoteViewModel();
    ...
    //ko.applyBindings(new ProductQuoteViewModel());
